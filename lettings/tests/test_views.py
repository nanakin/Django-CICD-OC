...
def test_index_view(client, letting_paris, letting_london):
    """Verify that the `index` view calls the right template and display the list of lettings."""
...
def test_letting_view(client, letting_london):
    """Verify that the `letting` view calls the right template and display the letting."""
